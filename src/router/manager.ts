            ...
            children: [
              {
                ...
                component: () =>
                  import("@/views/admin/views/student/views/QueryPage.vue"),
              },
              {
                path: "create",
                name: "adminManagerStudentCreate",
                component: () =>
                  import("@/views/admin/views/student/views/CreatePage.vue"),
              },
            ],
          },
          {
            ...
            children: [
              {
                ...
                component: () =>
                  import("@/views/admin/views/apply/views/ApplyPage.vue"),
              },
              {
                path: "history/accepted",
                name: "adminManagerApplyAC",
                component: () =>
                  import("@/views/admin/views/apply/views/AcceptPage.vue"),
              },
              {
                path: "history/rejected",
                name: "adminManagerApplyRE",
                component: () =>
                  import("@/views/admin/views/apply/views/RejectedPage.vue"),
              },
              {
                path: "history/finished",
                name: "adminManagerApplyFI",
                component: () =>
                  import("@/views/admin/views/apply/views/FinishedPage.vue"),
              },
              {
                path: "history/failed",
                name: "adminManagerApplyFA",
                component: () =>
                  import("@/views/admin/views/apply/views/FailedPage.vue"),
              },
            ],
          },
        ],
